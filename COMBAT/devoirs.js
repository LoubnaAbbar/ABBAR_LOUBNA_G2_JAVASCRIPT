class Personnage {
    ...
    attaquer(adversaire) {
        ...
        if (tiragePrecision < this.precision) {
            ...
            console.log(`${this.nom} a réussi à toucher ${adversaire.nom}!`);
    ...
    subirDegats(dégats) {
        ...
        console.log(`${this.nom} perd ${dégats} points de vie, il lui en reste ${this.pointsDeVie}.`);
...
function demarrerCombat() {
    ...
    console.log(`${guerrier1.nom} entre dans le Colisée avec ${guerrier1.pointsDeVie} points de vie.`);
    console.log(`${guerrier2.nom} entre dans le Colisée avec ${guerrier2.pointsDeVie} points de vie.`);
    ...
    const intervalId = setInterval(() => {
        if (guerrier1.estVivant() && guerrier2.estVivant()) {
            ...
            console.log(`${gagnant.nom} gagne le combat!`);
        }
    }, 1500);
}
